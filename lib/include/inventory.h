...
/*                                                                                          */
/* NAME                                                                                     */
/*     create_inventory - create a pointer to a new inventory structure filled with 0       */
/*                                                                                          */
/* RETURN VALUE                                                                             */
/*     The function return a pointer to an inventory_t struct or NULL if an error has       */
/*     occurred                                                                             */
...
/*                                                                                          */
/* RETURN VALUE                                                                             */
/*     The function return 0 if the item is correctly stacked else the function return -1 if*/
/*     there is no more places in the inventory (in this case the item will be placed in tmp*/
/*     part of the struct) and -2 if the inventory size is negative                         */
...
/*                                                                                          */
/* RETURN VALUE                                                                             */
/*     The function return 0 if the stack is correctly set else the function return -1 if   */
/*     there is no more places in the inventory (in this case the stack will be placed in   */
/*     tmp part of the struct) and -2 if the inventory size is negative                     */
/* my_rpg                                 2019-04-01                               ADD_ITEM */
